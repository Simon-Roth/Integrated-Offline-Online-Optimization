...
VOL_MID_VAR = (3.0, 7.0)  # kappa=10 (medium variance)
VOL_HIGH_VAR = (0.3, 0.7)  # kappa=1 (high variance, same mean as baseline)
...
add_scenario_with_feas_variants(
    ...
    overrides={
        **ratio_overrides(120),
        **volume_overrides(VOL_HIGH_VAR, DEFAULT_BOUNDS),
        **base_cost_graph_overrides(),
    },
    description="High-variance coefficients: Beta(0.3,0.7) on [30,180] with fixed capacity settings.",
)

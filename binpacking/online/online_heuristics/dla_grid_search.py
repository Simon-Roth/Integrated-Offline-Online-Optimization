...
OFFLINE_SOLVER = "generic.offline.offline_solver.OfflineMILPSolver" # just for initialisation as Moff = 0 here
ONLINE_POLICY = "binpacking.online.online_heuristics.dynamic_learning.DynamicLearningPolicy"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Base YAML config (merged with configs/generic.yaml).",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("binpacking/results/dla_grid"),
